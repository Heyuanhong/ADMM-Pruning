...
XLM_START_DOCSTRING = r"""    The XLM model was proposed in
    ...
    Parameters:
        config (:class:`~ori_transformers.XLMConfig`): Model configuration class with all the parameters of the model.
...
XLM_INPUTS_DOCSTRING = r"""
    Inputs:
        **input_ids**: ``torch.LongTensor`` of shape ``(batch_size, sequence_length)``:
            ...
            Indices can be obtained using :class:`ori_transformers.XLMTokenizer`.
