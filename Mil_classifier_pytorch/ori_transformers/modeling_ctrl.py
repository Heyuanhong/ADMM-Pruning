...
CTRL_START_DOCSTRING = r"""    CTRL model was proposed in 
    ...
    Parameters:
        config (:class:`~ori_transformers.CTRLConfig`): Model configuration class with all the parameters of the model.
...
CTRL_INPUTS_DOCSTRING = r"""    Inputs:
        **input_ids**: ``torch.LongTensor`` of shape ``(batch_size, sequence_length)``:
            ...
            Indices can be obtained using :class:`ori_transformers.CTRLTokenizer`.
...
class CTRLLMHeadModel(CTRLPreTrainedModel):
    ...
    Examples::
        ...
        import torch
        from ori_transformers import CTRLTokenizer, CTRLLMHeadModel
