...
class AutoModel(object):
    r"""
        :class:`~ori_transformers.AutoModel` is a generic model class
...
class AutoModelWithLMHead(object):
    r"""
        :class:`~ori_transformers.AutoModelWithLMHead` is a generic model class
...
class AutoModelForSequenceClassification(object):
    r"""
        :class:`~ori_transformers.AutoModelForSequenceClassification` is a generic model class
...
class AutoModelForQuestionAnswering(object):
    r"""
        :class:`~ori_transformers.AutoModelForQuestionAnswering` is a generic model class
