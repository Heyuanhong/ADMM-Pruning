...
OPENAI_GPT_START_DOCSTRING = r"""    OpenAI GPT model was proposed in
    ...
    Parameters:
        config (:class:`~ori_transformers.OpenAIGPTConfig`): Model configuration class with all the parameters of the model.
...
OPENAI_GPT_INPUTS_DOCSTRING = r"""    Inputs:
        **input_ids**: ``torch.LongTensor`` of shape ``(batch_size, sequence_length)``:
            ...
            Indices can be obtained using :class:`ori_transformers.BPT2Tokenizer`.
