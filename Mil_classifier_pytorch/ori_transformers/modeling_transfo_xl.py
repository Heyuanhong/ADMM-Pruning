...
TRANSFO_XL_START_DOCSTRING = r"""    The Transformer-XL model was proposed in
    ...
    Parameters:
        config (:class:`~ori_transformers.TransfoXLConfig`): Model configuration class with all the parameters of the model.
...
TRANSFO_XL_INPUTS_DOCSTRING = r"""
    Inputs:
        **input_ids**: ``torch.LongTensor`` of shape ``(batch_size, sequence_length)``:
            ...
            Indices can be obtained using :class:`ori_transformers.TransfoXLTokenizer`.
